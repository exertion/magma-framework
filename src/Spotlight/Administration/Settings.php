...
class Settings
{
    ...
    {
        self::$prefix = str_replace('-', '_', Helper::slugify(config('app.name', 'Magma'))); // Build prefix from plugin name.
    ...
    public function setupMenu()
    {
    	...
    	$menu['page_title'] = __( config('app.name', 'Magma').' Settings' );
    ...
    */
    ...
    public static function init()
    {
        if (self::$enabled) {
            ...
            $panel->set_page_title( __( config('app.name', 'Magma').' Settings' ) );
